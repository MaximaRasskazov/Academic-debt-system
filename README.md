...
### 🏛 Деканат
- Назначает пересдачи (обычные и комиссионные ≥3 преподавателей)
- Одобряет заявки преподавателей и изменения составов
- Выгружает сводную аналитику по потокам (XLSX/CSV)
- Двухэтапные ведомости пересдачи
...
- Управление справочником дисциплин (CRUD + soft-delete)
- Просмотр аудита и истории изменений
- Контроль синхронизации с внешним эмулятором
