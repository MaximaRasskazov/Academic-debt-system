...
func registerOne(t *testing.T, svc *auth.Service, prefix string) (id uuid.UUID, email, password string) {
	t.Helper()
...
func TestUpdateProfile_UpdatesOnlyProvidedFields(t *testing.T) {
	...
	uid, _, _ := registerOne(t, svc, "patch-partial")
...
func TestUpdateProfile_TrimSpaces(t *testing.T) {
	_, svc := testServices(t)
	uid, _, _ := registerOne(t, svc, "patch-trim")
...
func TestUpdateProfile_RejectsEmptyFirstLastName(t *testing.T) {
	_, svc := testServices(t)
	uid, _, _ := registerOne(t, svc, "patch-empty")
...
func TestChangePassword_HappyPath(t *testing.T) {
	_, svc := testServices(t)
	uid, email, oldPwd := registerOne(t, svc, "pwd-ok")
...
func TestChangePassword_WrongCurrent(t *testing.T) {
	_, svc := testServices(t)
	uid, _, _ := registerOne(t, svc, "pwd-bad")
...
func TestChangePassword_TooShort(t *testing.T) {
	_, svc := testServices(t)
	uid, _, oldPwd := registerOne(t, svc, "pwd-short")
...
func TestChangePassword_SameAsCurrent(t *testing.T) {
	_, svc := testServices(t)
	uid, _, oldPwd := registerOne(t, svc, "pwd-same")
